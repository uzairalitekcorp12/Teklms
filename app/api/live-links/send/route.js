...
export async function POST(request){
  ...
  try{
    ...
    return NextResponse.json({ok:true,emailConfigured:true,testMode:true,status:failed?'partial':'sent',sent,failed,recipientCount:recipients.length},{headers:{'Cache-Control':'no-store'}})
  }catch{
