...
const items=[[BookOpen,'12+','Academic workflows'],[UsersRound,'1.2K+','Student records'],[WalletCards,'360°','Fee visibility'],[MessageCircleMore,'1-click','Communication access']];
