...
export const initialStudents = Array.from({length:96},(_,i)=>({
  ...
  email:i===9?'teklms@student':`student${i+1}@teklms.edu`,
  phone:i===9?'+92312313122':`+92 3${String(10+(i%89)).padStart(2,'0')} ${String(1000000+i*731).slice(-7)}`,
